...
# adaptyst-analyser-nvgpu

[![License: GNU GPL v3](https://img.shields.io/badge/license-GNU%20GPL%20v3-blue)]()
[![Version](https://img.shields.io/github/v/release/adaptyst/adaptyst-analyser-nvgpu?include_prereleases&label=version)](https://github.com/Adaptyst/adaptyst-analyser-nvgpu/releases)

The Adaptyst Analyser module responsible for inspecting results produced by [adaptyst-nvgpu](https://github.com/adaptyst/adaptyst-nvgpu).
...
See [the Adaptyst Analyser documentation](https://adaptyst.web.cern.ch/docs/adaptyst/checking-results-with-adaptyst-analyser) and [the adaptyst-nvgpu documentation](https://adaptyst.web.cern.ch/docs/modules/nvgpu-nvidia-gpus).
